 ...
 */
/**
 * @ConfigurationProperties 注解只是声明要从 application.yml 里读取配置。本身不会自动变成 Bean。
 * 若要变成 Bean，则需要 @EnableConfigurationProperties 注解
 */
@ConfigurationProperties(prefix = "java-forge.dynamic-config.redis", ignoreInvalidFields = true)
